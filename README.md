...
Use ⌥ ← and ⌥→ to jump forwards / backwards words in iTerm2, on OS X
...
In iTerm set the Left Option key to Esc+. Go to iTerm2 --> Settings --> Profiles --> Keys --> General

![Left Option key](https://raw.githubusercontent.com/brunnerklaus/dotfiles/master/img/iterm_keys_general.jpg)
...
[Jason’s dotfiles](https://github.com/jsnmrs/dotfiles)
